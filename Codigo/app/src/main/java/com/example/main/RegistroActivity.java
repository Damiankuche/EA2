    ...
    public void registrar(){
        ...
        if (isOnline()) {
            ...
            try {
                ...
                Toast.makeText(RegistroActivity.this,"Error en los parametros ingresados o estos están vacios.",Toast.LENGTH_SHORT).show();
                Log.e(TAG,"Error: "+e.getMessage());
            }
        } else {
            Toast.makeText(RegistroActivity.this, "No tienes conexión a internet.", Toast.LENGTH_SHORT).show();
        }
    }
